...
import controller.DepartmentPanelController;

public class DepartmentPanelView extends JPanel {
	...
	public DepartmentPanelView(String string) {
		...
		DepartmentPanelModel model = new DepartmentPanelModel(this);
		DepartmentPanelController controller = new DepartmentPanelController(model, this);
		controller.control();
	}
	...
	public String getIdTextField() {
		return numberDepartmentTextField.getText();
	}
	
	public String getNameTextField() {
		return nameDepartmentTextField.getText();
	}
