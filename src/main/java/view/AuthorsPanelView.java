...
import controller.AuthorsPanelController;

public class AuthorsPanelView extends JPanel{
	/**
	 * 
	 */
	...
	public AuthorsPanelView(String string) {
		...
		this.add(scrollPane, gbc_tableAuthor);
		
		AuthorsPanelModel model = new AuthorsPanelModel(this);
		AuthorsPanelController controller = new AuthorsPanelController(model, this);
		controller.control();
	}
	...
	public JTable getResultTable() {
		return searchAuthorResultTable;
	}
	
	public String getIdTextField() {
		return numberAuthorTextField.getText();
	}
	
	public String getSurnameTextField() {
		return surnameAuthorTextField.getText();
	}
	
	public String getNameTextField() {
		return nameAuthorTextField.getText();
	}
}
